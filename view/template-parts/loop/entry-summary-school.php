...
<a href="<?php the_permalink(); ?>">
	<section class="c-entry-summary c-entry-summary--post">
		<?php Helper::get_template_part( 'template-parts/loop/entry-summary/figure/figure', 'school' ); ?>

		<div class="c-entry-summary__body">
			<header class="c-entry-summary__header">
				<?php Helper::get_template_part( 'template-parts/loop/entry-summary/title/title', 'school' ); ?>
			</header>
			...
			<?php Helper::get_template_part( 'template-parts/loop/entry-summary/meta/meta', 'school' ); ?>
		</div>
	</section>
</a>
